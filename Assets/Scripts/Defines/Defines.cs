...
public static class Defines
{
    ...
    public static readonly float spacing = 3f; //每个格子间距
    ...
    //塔防相关常量
    public static readonly Color validRangeColor = new Color(1, 1, 1, 1f); //合法范围的颜色
    public static readonly Color invalidRangeColor = new Color(1f, 0f, 0f, 1f); //无效范围的颜色
